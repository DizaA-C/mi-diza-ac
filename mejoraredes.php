...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validar campos
    if (empty($nombre) || empty($email) || empty($redes) || empty($mensaje)) {
        echo "<script>
    ...
    $contenido = "Solicitud de mejora en redes sociales:\n\n";
    $contenido .= "Nombre: $nombre\n";
    $contenido .= "Correo Electrónico: $email\n";
    $contenido .= "Red Social a Mejorar: $redes\n";
    $contenido .= "Mensaje:\n$mensaje\n";
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = "Nueva Solicitud de Mejora en Redes Sociales";
        ...
        if ($mail->send()) {
            echo "<script>
                    ...
                    window.location.href = 'mejorar-redes.html';
                  </script>";
        } else {
            echo "<script>
